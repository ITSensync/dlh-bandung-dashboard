...
<template>
  <div
    class="w-full md:col-span-2 lg:w-1/3 bg-slate-900/70 rounded-xl flex flex-col pt-2 pb-4 min-h-full"
  >
    <!-- <div></div> -->
    ...
    <!-- NILAI -->
    <div class="flex flex-row gap-2 mt-2 h-full">
      <div class="w-1/2 items-center py-5 flex justify-center">
        <div
          class="rounded-full h-[20vh] w-[20vh] flex justify-center items-center"
      ...
      <div class="w-1/2 flex flex-col items-center justify-center gap-2 p-2">
        ...
        <p class="font-poppins font-normal text-md text-center">{{ ispuLatestData?.ket }}</p>
      </div>
    </div>
  </div>
</template>
