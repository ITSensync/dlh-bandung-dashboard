  ...
  <div class="w-full bg-slate-900/70 rounded-xl flex flex-col pt-2 pb-4 min-h-full">
    ...
    <div class="flex flex-row gap-2 mt-2 h-full">
      <div class="w-1/2 items-center py-5 flex justify-center">
        ...
        >
          <p
            class="font-poppins font-extrabold text-5xl sm:text-8xl md:text-6xl xl:text-5xl 2xl:text-8xl text-center text-shadow-lg"
          >
            {{ maxIspu.value }}
          </p>
        </div>
      ...
      <div class="w-1/2 flex flex-col items-center justify-center gap-2 p-2 text-center">
        ...
        <p class="font-poppins font-bold text-xl sm:text-3xl xl:text-xl 2xl:text-4xl">
          {{ ispuLatestData?.status }}
        </p>
        <p class="font-poppins font-normal text-md xl:text-xs text-center 2xl:text-xl">
          {{ ispuLatestData?.ket }}
        </p>
      </div>
    </div>
