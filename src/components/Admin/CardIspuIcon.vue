...
function generateIcon(value) {
  switch (true) {
    ...
    case value > 50 && value <= 100:
      // 😐 Sedang
      return `
        <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 xl:w-30 xl:h-30 2xl:w-40 2xl:h-40 text-sky-500" viewBox="0 0 24 24"><!-- Icon from css.gg by Astrit - https://github.com/astrit/css.gg/blob/master/LICENSE --><g fill="currentColor"><path d="M9 11a1 1 0 1 0 0-2a1 1 0 0 0 0 2m0 4a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2zm7-5a1 1 0 1 1-2 0a1 1 0 0 1 2 0"/><path fill-rule="evenodd" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10m-2 0a8 8 0 1 1-16 0a8 8 0 0 1 16 0" clip-rule="evenodd"/></g></svg>`
