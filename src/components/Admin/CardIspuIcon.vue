...
<template>
  <CardBox>
    <div class="flex flex-col xl:flex-row gap-2 mt-2 h-full items-center px-10">
      <div class="w-full xl:w-1/2">
        <div v-html="generateIcon(maxIspu.value)" class="flex justify-center"></div>
      </div>
      <div class="w-full xl:w-1/2">
        <p
          class="font-poppins text-center xl:text-start font-bold text-sm sm:text-base md:text-lg xl:text-base 2xl:text-xl 3xl:text-xl 4xl:text-3xl"
        >
          {{ ispuLatestData?.ket }}
        </p>
      </div>
